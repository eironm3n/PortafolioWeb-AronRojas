...
const habilidades = ref([
    ...
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            ...
            { id: 3, nombre: 'Node.js', nivel: 'Intermedio', icono: img8 },
            { id: 4, nombre: 'Django', nivel: 'Intermedio', icono: img9 },
            { id: 5, nombre: 'Bootstrap', nivel: 'Intermedio', icono: img10 }
        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            ...
            { id: 5, nombre: 'Visual Studio Code', nivel: 'Intermedio', icono: img15 }
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 1, nombre: 'MongoDB', nivel: 'Intermedio', icono: img16 },
